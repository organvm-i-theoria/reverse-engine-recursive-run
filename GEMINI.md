...
**Org:** `organvm-iv-taxis` | **Repo:** `reverse-engine-recursive-run`

### Edges
- **Produces** → `unspecified`: theory

### Siblings in Orchestration
`orchestration-start-here`, `petasum-super-petasum`, `universal-node-network`, `.github`, `agentic-titan`, `agent--claude-smith`, `a-i--skills`, `tool-interaction-design`, `system-governance-framework`, `collective-persona-operations`
...
Run: `organvm ecosystem show reverse-engine-recursive-run` | `organvm ecosystem validate --organ IV`
...
Convergences: 20 | Run: `organvm network map --repo reverse-engine-recursive-run` | `organvm network suggest`


## Entity Identity (Ontologia)

**UID:** `ent_repo_01KKKX3RVQQS80VNJR6K9Y81QH` | **Matched by:** primary_name

Resolve: `organvm ontologia resolve reverse-engine-recursive-run` | History: `organvm ontologia history ent_repo_01KKKX3RVQQS80VNJR6K9Y81QH`
