...
`reverse-engine-recursive-run` is a Python-based project within ORGAN-I (Theoria) of the organvm eight-organ creative-institutional system. The project needed a technology foundation that balances rapid prototyping with long-term maintainability, aligning with the organ system's emphasis on portfolio-quality engineering.
